...
<head>
    ...
    <title>Login - Reservasi Ruang Rapat</title>
...
<body class="bg-cream-100 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md">
        <div class="bg-cream-50 rounded-lg shadow-2xl overflow-hidden border border-cream-200">
            <div class="bg-dark-red px-6 py-8 text-center">
                ...
                <h1 class="text-white text-2xl font-bold">Reservasi Ruang Rapat</h1>
                <p class="text-red-100 text-sm mt-2">Masuk ke akun Anda</p>
            </div>
            ...
            <div class="px-6 py-8">
                ...
                <div class="mt-6 text-center">
                    <p class="text-gray-600 text-sm">
                        Belum punya akun? 
                        <a href="{{ route('register') }}" class="text-dark-red hover:underline font-medium">Daftar di sini</a>
                    </p>
                </div>
            </div>
        </div>
